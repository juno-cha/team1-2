    ...
    export default {
        ...
        methods: {
            ...
            async bikeRepair() {
                try {
                    if(!this.offline) {
                        var temp = await axios.put(axios.fixUrl(this.value._links['bikerepair'].href))
                        for(var k in temp.data) {
                            this.value[k]=temp.data[k];
                        }
                    }
            ...
            async bikeRepairComplete() {
                try {
                    if(!this.offline) {
                        var temp = await axios.put(axios.fixUrl(this.value._links['bikerepaircomplete'].href))
                        for(var k in temp.data) {
                            this.value[k]=temp.data[k];
                        }
                    }
